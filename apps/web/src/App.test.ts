...
describe("project navigation", () => {
  it("groups local and resumable chats under one normalized workspace", () => {
    ...
    expect(workspaceName("C:\\FixtureHome\\Project\\")).toBe("Project");
  });
  ...
  it("never exposes current or legacy internal quota workspaces", () => {
    const paths = [
      "C:/FixtureHome/AppData/Roaming/KimiCodeDesktop/runtime/quota-probe",
      "C:/FixtureHome/AppData/Roaming/com.kimicode.desktop/runtime/quota-probe",
      "E:/work/real-project",
    ];
  ...
  it("keeps standalone chats out of project groups and preserves manual project order", () => {
    const threads = [{ cwd: "C:/FixtureHome/AppData/Roaming/KimiCodeDesktop/runtime/chats", kind: "chat", title: "Personal chat" }] as unknown as Parameters<typeof groupProjects>[1];
