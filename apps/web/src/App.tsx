      ...
      <aside className="sidebar" aria-label="Kimi Code navigation">
        ...
        <footer className="sidebar-footer">
          ...
          <div className="sidebar-footer-actions">
            ...
            {showSidebarUpdate(updateStatus.phase) && <button className={`sidebar-update ${updateStatus.phase}`} type="button" aria-label={updateStatus.phase === "available" ? `Install Kimi Code ${updateStatus.version ?? "update"} and restart` : `${updateStatus.phase === "downloading" ? "Downloading" : "Installing"} Kimi Code update`} title={updateStatus.phase === "available" ? "Install update & restart" : `${updateStatus.phase === "downloading" ? "Downloading" : "Installing"} update`} disabled={updatePreparing || updateStatus.phase !== "available"} onClick={() => void installUpdate()}>{updateStatus.phase === "available" ? <DownloadSimple /> : <ArrowsClockwise />}<span>{updatePreparing ? "Preparing" : updateStatus.phase === "available" ? "Update" : updateStatus.phase === "downloading" && updateStatus.percent !== undefined ? `${updateStatus.percent}%` : "Updating"}</span></button>}
          </div>
        </footer>
      </aside>
