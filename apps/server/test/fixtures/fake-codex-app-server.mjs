...
createInterface({ input: process.stdin }).on("line", (line) => {
  ...
  else if (message.method === "thread/read") send({ id: message.id, result: { thread: { id: message.params.threadId, name: "Test explorer", agentRole: "explore", status: "idle", turns: [{ id: "child-turn", status: "completed", durationMs: 42, items: [{ type: "reasoning", id: "reasoning-child", summary: ["Inspect tests"], content: [] }, { type: "commandExecution", id: "command-child", command: "pnpm test", status: "completed", aggregatedOutput: "57 tests passed" }, { type: "agentMessage", id: "message-child", text: "The tests are green." }] }] } } });
