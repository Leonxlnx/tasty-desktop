...
describe("Kimi subscription quota", () => {
  it("recognizes current and legacy app-owned quota workspaces", () => {
    const current = "C:/FixtureHome/AppData/Roaming/com.kimicode.desktop/runtime/quota-probe";
    expect(isKimiQuotaProbePath(current, current)).toBe(true);
    expect(isKimiQuotaProbePath("C:/FixtureHome/AppData/Roaming/KimiCodeDesktop/runtime/quota-probe", current)).toBe(true);
